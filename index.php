...
<body>
  <div class="md:container md:mx-auto bg-stone-500">
             ...
             <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" id='form'>
               ...
               <div class="mb-4">
                 ...
                 <div class="flex items-center mb-2">
                   <input class="shadow appearance-none border rounded w-1/4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="producto-id" type="text" placeholder="ID del producto">
                   <input class="ml-2 shadow appearance-none border rounded w-3/4 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="producto-nombre" type="text" placeholder="Nombre del producto">
                 </div>
